...
import com.example.HandlingKafkaErrors.model.Loc;
...
//      start the container:
    ...
    void sendMessage() throws InterruptedException, JsonProcessingException {
        ...
        Person pushed_person = new Person("keyfar", "farid", "imakh",32,new Loc(2.2414, 2.2155),"null");
    ...
    private Map<String, Object> getConsumerProperties() {
        return Map.of(
                ...
                ConsumerConfig.GROUP_ID_CONFIG, "local-consumer",
